...
export default function Chat({ onFocusEntity, onAimGraph, onOpenDoc, onTrail, field, ask }) {
  ...
  async function send(q, m) {
    ...
    try {
      ...
      if (res.focus_entities?.length) (onAimGraph || onFocusEntity)?.(res.focus_entities.join(","));
